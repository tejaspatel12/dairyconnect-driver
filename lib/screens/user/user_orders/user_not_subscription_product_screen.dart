...
class UserNotSubscriptionProductScreen extends StatefulWidget {
  final String user_id,user_first_name,user_last_name;
const UserNotSubscriptionProductScreen({Key key, @required this.user_id, @required this.user_first_name, @required this.user_last_name}) : super(key: key);
  // UserNotSubscriptionProductScreenState createState() => UserNotSubscriptionProductScreenState();
  State<UserNotSubscriptionProductScreen> createState() => UserNotSubscriptionProductScreenState(user_id,user_first_name,user_last_name);
}

class UserNotSubscriptionProductScreenState extends State<UserNotSubscriptionProductScreen> {
  BuildContext _ctx;
  String user_id,user_first_name,user_last_name;

  UserNotSubscriptionProductScreenState(this.user_id,this.user_first_name,this.user_last_name);
  ...
  Future<List<ProductList>> getProductData() async
  {
    ...
    return _netUtil.post(RestDatasource.GET_DELIVEYBOY, body: {
      'action': "user_not_subscription_product",
      "user_id": user_id,
      // "featured_product":"1",
    }).then((dynamic res)
    {
  ...
  Widget build(BuildContext context) {
    ...
    if (isOffline) {
      ...
      return Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: new Text("Subscription Product",style: TextStyle(color: Colors.white),),
                                                                      ...
                                                                      onTap: () {
                                                                        ...
                                                                        else
                                                                        {
                                                                          ...
                                                                          if (_isProccessing == false) {
                                                                            ...
                                                                            //     msg: DateFormat('yyyy-MM-dd').format(mordate).toString(),
                                                                            ...
                                                                            if (form.validate()) {
                                                                              ...
                                                                              _netUtil.post(RestDatasource.GET_DELIVEYBOY, body: {
                                                                                'action': "deliveryboy_order_everyday_subscription_product",
                                                                                "user_id": user_id,
                                                                                "product_id": data.product_id,
                                                                                "product_name": data.product_name,
                                                                                "attribute_id": data.attribute_id,
                                                                                "cutoff_time": cutoff_time,
                                                                                "product_price": user_type=="1"?data.product_regular_price.toString():data.product_normal_price.toString(),
                                                                                                        ...
                                                                                                        child: InkWell(
                                                                                                          ...
                                                                                                          child: Padding(
                                                                                                            ...
                                                                                                            child: Container(
                                                                                                              ...
                                                                                                              padding: EdgeInsets.fromLTRB(10, 12, 10, 12),
                                                                                                              alignment: Alignment.center,
                                                                                                              child: Text("Ok".toString(),style: TextStyle(fontSize: textSizeSMedium,color:Colors.white,fontWeight: FontWeight.w600),),
                                                                                                            ),
                                                                                                          ),
                                                                                                        ),
