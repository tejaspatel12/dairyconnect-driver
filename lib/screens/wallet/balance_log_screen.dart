                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Text(data.ubl_amount==null?"":data.ubl_amount, style: TextStyle(color: blackcolor,fontSize: textSizeSMedium, fontWeight: FontWeight.w400, letterSpacing: 0.5)),
                                        ],
                                      ),
                                      SizedBox(
                                        height: spacing_middle,
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Text(data.ubl_date==null?"":data.ubl_date, style: TextStyle(color: blackcolor,fontSize: textSizeSMedium, fontWeight: FontWeight.w400, letterSpacing: 0.5)),
                                        ],
                                      ),
                                    ],
                                  ),
